...
public class StudyPathologicalAnatomyFactory implements IClinicalDocumentFactory {
	 ...
	 */
	@Override
	public String buildXmlCdaClinicalDocument(
	...
	private ReportStudyImages reportFactory(ReportIntegration reportIntegration) throws Exception {
		...
		reportStudyImages.setTitle(ReportConstant.ReportTitle.ANATOMY_PATOLOGICA);
...
//		low.setValue(reportIntegration.getEpisode().getDateAmission());
	 ...
	 * @throws Exception 
	 */
	private ReportStudyImages.Components.StructuredBody.Component componentFactory(String systemName, ReportIntegration.ClinicoContent clinicoContent) throws Exception {
...
//		template.setExtension(ReportConstant.TYPE_EXTENSION);		
		...
		text.setContent(clinicoContent.getDescription());
