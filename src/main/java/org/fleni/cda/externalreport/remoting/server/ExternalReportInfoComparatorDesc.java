...
public class ExternalReportInfoComparatorDesc implements Comparator<ExternalReportInfo> {
	/**
     * Método sobrecargado que se encarga de comparar por fechas.
     * @param e1 Date fchComparar1
     * @param e2 Date fchComparar2
     * @return +1, 0, -1 si la fecha 1 es anterior, igual o posterior que la fecha 2
     */
	@Override
