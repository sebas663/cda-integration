...
@DiscriminatorValue(value = "CONFIDENTIALITY_LEVEL")
public class ConfidentialityType extends ConvertMasterType {
	...
	private static final String DISCRIMINATOR = "CONFIDENTIALITY_LEVEL";
