...
/**
 * QProvidersType is a Querydsl query type for ProvidersType
 */
@Generated("com.mysema.query.codegen.EntitySerializer")
public class QProvidersType extends EntityPathBase<ProvidersType> {

    private static final long serialVersionUID = 1301604294L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QProvidersType providersType = new QProvidersType("providersType");
    ...
    public QProvidersType(String variable) {
        this(ProvidersType.class, forVariable(variable), INITS);
    }

    public QProvidersType(Path<? extends ProvidersType> path) {
        this(path.getType(), path.getMetadata(), path.getMetadata().isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QProvidersType(PathMetadata<?> metadata) {
        this(metadata, metadata.isRoot() ? INITS : PathInits.DEFAULT);
    }

    public QProvidersType(PathMetadata<?> metadata, PathInits inits) {
        this(ProvidersType.class, metadata, inits);
    }

    public QProvidersType(Class<? extends ProvidersType> type, PathMetadata<?> metadata, PathInits inits) {
